-- |
-- Module      :  Phonetic.Languages.Lists.Ukrainian.PropertiesSyllablesG
...
rhythmicity03 :: String -> Float
rhythmicity03 xs
 | null xs = 0.0
 | otherwise = eval23 . syllableDurations3 . createSyllablesUkr $ xs

rhythmicityK3 :: Float -> Float -> String -> Float
rhythmicityK3 k2 k3 xs
 | null xs = 0.0
 | otherwise = eval23K k2 k3 . syllableDurations3 . createSyllablesUkrP $ xs
